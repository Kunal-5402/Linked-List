...
template <class t>
bool linked_list<t>::search_for_an_element()
{
    t data;
...
template <class t>
node<t> *linked_list<t>::search(t s_data)
{
    node<t> *temp = head;
    while (temp != NULL)
    {
...
template <class t>
void linked_list<t>::insert_at_beginning()
{
    t data;
    cout << "Enter the data: ";
    cin >> data;
...
template <class t>
void linked_list<t>::insert_at_mid()
{
    t data, s_data;
...
template <class t>
void linked_list<t>::delete_from_beginning()
{
    if (head == NULL)
    {
...
template <class t>
void linked_list<t>::delete_from_mid()
{
    if (head == NULL)
    {
        cout << "List is empty" << endl;
...
template <class t>
void linked_list<t>::delete_from_end()
{
    if (head == NULL)
    {
        cout << "List is empty" << endl;
